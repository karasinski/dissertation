...
This change implies that the subjects in our experiments do their primary learning while they are receiving qualitative feedback, and that their current level of responsiveness is not sufficient to complete the task.
...
Currently, it is unclear if this percentage of time is task dependent or if, for example, it simply represents the average boundary of human control for this task.
