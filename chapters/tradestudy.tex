...
% Admoni and Scassellati, 2017~\citep{admoni_social_2017}
% 			x
% Ahmad et al., 2017~\citep{ahmad_systematic_2017}
% x	x
% Chen and Barnes, 2014~\citep{chen_humanagent_2014}
% x	x	x
% Endsley 2017~\citep{endsley_here_2017}
% x	x		x
% Guiochet et al., 2017~\citep{guiochet_safety-critical_2017}
% 			x
% Kehoe et al., 2015~\citep{kehoe_survey_2015}
% x		x
% Kolling et al., 2016~\citep{kolling_human_2016}
% 	x	x
% Liu and Wang, 2018~\citep{liu_gesture_2018}
% x
% Losey et al., 2018~\citep{losey_review_2018}
% x	x		x
% Lu et al., 2016~\citep{lu_human_2016}
% 	x
% Ososky et al., 2013~\citep{ososky_building_2013}
% 		x	x
% Parasuraman and Wickens, 2008~\citep{parasuraman_humans:_2008}
% 	x
% Phillips et al., 2016~\citep{phillips_human-animal_2016}
% 			x
% Rautaray and Agrawal, 2015~\citep{rautaray_vision_2015}
% x
% Schaefer et al., 2016~\citep{schaefer_meta-analysis_2016}
% 			x
% Sheridan, 2016~\citep{sheridan_humanrobot_2016}
% x			x
% Vagia et al., 2016~\citep{vagia_literature_2016}
% 	x
% Wang et al., 2018~\citep{wang_current_2018}
% x		x
% Zamora et al., 2017~\citep{zamora_machine_2017}
% x
...
% NASA has identified four gaps in HARI knowledge, as part of the larger HFBP characterization of human factors risks and associated knowledge gaps [41].
...
% Table 7 provides a complete mapping of the relationships between with research topics and HARI gaps.
...
%~\citep{admoni_social_2017}	H. Admoni and B. Scassellati, ``Social Eye Gaze in Human-robot Interaction: A Review,'' J. Hum.-Robot Interact., vol. 6, no. 1, pp. 25–63, May 2017.
%~\citep{ahmad_systematic_2017}	M. Ahmad, O. Mubin, and J. Orlando, ``A Systematic Review of Adaptivity in Human-Robot Interaction,'' Multimodal Technologies and Interaction, vol. 1, no. 3, p. 14, Sep. 2017.
%~\citep{chen_humanagent_2014}	J. Y. Chen and M. J. Barnes, ``Human–agent teaming for multirobot control: A review of human factors issues,'' IEEE Transactions on Human-Machine Systems, vol. 44, no. 1, pp. 13–29, 2014.
%~\citep{endsley_here_2017}	M. R. Endsley, ``From Here to Autonomy: Lessons Learned From Human–Automation Research,'' Hum Factors, vol. 59, no. 1, pp. 5–27, Feb. 2017.
%~\citep{guiochet_safety-critical_2017}	J. Guiochet, M. Machin, and H. Waeselynck, ``Safety-critical advanced robots: A survey,'' Robotics and Autonomous Systems, vol. 94, pp. 43–52, Aug. 2017.
%~\citep{kehoe_survey_2015}	B. Kehoe, S. Patil, P. Abbeel, and K. Goldberg, ``A Survey of Research on Cloud Robotics and Automation,'' IEEE Transactions on Automation Science and Engineering, vol. 12, no. 2, pp. 398–409, Apr. 2015.
%~\citep{kolling_human_2016}	A. Kolling, P. Walker, N. Chakraborty, K. Sycara, and M. Lewis, ``Human Interaction With Robot Swarms: A Survey,'' IEEE Transactions on Human-Machine Systems, vol. 46, no. 1, pp. 9–26, Feb. 2016.
%~\citep{liu_gesture_2018}	H. Liu and L. Wang, ``Gesture recognition for human-robot collaboration: A review,'' International Journal of Industrial Ergonomics, vol. 68, pp. 355–367, Nov. 2018.
%~\citep{losey_review_2018}	D. P. Losey, C. G. McDonald, E. Battaglia, and M. K. O'Malley, ``A Review of Intent Detection, Arbitration, and Communication Aspects of Shared Control for Physical Human–Robot Interaction,'' Appl. Mech. Rev, vol. 70, no. 1, pp. 010804-010804–19, Feb. 2018.
%~\citep{lu_human_2016}	Z. Lu, R. Happee, C. D. Cabrall, M. Kyriakidis, and J. C. de Winter, ``Human factors of transitions in automated driving: A general framework and literature survey,'' Transportation research part F: traffic psychology and behaviour, vol. 43, pp. 183–198, 2016.
%~\citep{ososky_building_2013}	S. Ososky, D. Schuster, E. Phillips, and F. G. Jentsch, ``Building Appropriate Trust in Human-Robot Teams,'' in 2013 AAAI Spring Symposium Series, 2013.
%~\citep{parasuraman_humans:_2008}	R. Parasuraman and C. D. Wickens, ``Humans: Still vital after all these years of automation,'' Human factors, vol. 50, no. 3, pp. 511–520, 2008.
%~\citep{phillips_human-animal_2016}	E. Phillips, K. E. Schaefer, D. R. Billings, F. Jentsch, and P. A. Hancock, ``Human-animal Teams As an Analog for Future Human-robot Teams: Influencing Design and Fostering Trust,'' J. Hum.-Robot Interact., vol. 5, no. 1, pp. 100–125, Mar. 2016.
%~\citep{rautaray_vision_2015}	S. S. Rautaray and A. Agrawal, ``Vision based hand gesture recognition for human computer interaction: a survey,'' Artif Intell Rev, vol. 43, no. 1, pp. 1–54, Jan. 2015.
%~\citep{schaefer_meta-analysis_2016}	K. E. Schaefer, J. Y. C. Chen, J. L. Szalma, and P. A. Hancock, ``A Meta-Analysis of Factors Influencing the Development of Trust in Automation: Implications for Understanding Autonomy in Future Systems,'' Hum Factors, vol. 58, no. 3, pp. 377–400, May 2016.
%~\citep{sheridan_humanrobot_2016}	T. B. Sheridan, ``Human–Robot Interaction: Status and Challenges,'' Hum Factors, vol. 58, no. 4, pp. 525–532, Jun. 2016.
%~\citep{vagia_literature_2016}	M. Vagia, A. A. Transeth, and S. A. Fjerdingen, ``A literature review on the levels of automation during the years. What are the different taxonomies that have been proposed?,'' Applied ergonomics, vol. 53, pp. 190–202, 2016.
%~\citep{wang_current_2018}	T.-M. Wang, Y. Tao, and H. Liu, ``Current Researches and Future Development Trend of Intelligent Robot: A Review,'' International Journal of Automation and Computing, vol. 15, no. 5, pp. 525–546, 2018.
%~\citep{zamora_machine_2017}	M. Zamora, E. Caldwell, J. Garcia-Rodriguez, J. Azorin-Lopez, and M. Cazorla, ``Machine Learning Improves Human-Robot Interaction in Productive Environments: A Review,'' in Advances in Computational Intelligence, 2017, pp. 283–293.
%~\citep{8701742}	Z. He, ``Gesture Recognition Based on Tri-Axis Accelerometer Using 1D Gabor Filters,'' in 2018 9th International Symposium on Parallel Architectures, Algorithms and Programming (PAAP), 2018, pp. 146–151.
%~\citep{beer_toward_2014}	J. M. Beer, A. D. Fisk, and W. A. Rogers, ``Toward a Framework for Levels of Robot Autonomy in Human-robot Interaction,'' J. Hum.-Robot Interact., vol. 3, no. 2, pp. 74–99, Jul. 2014.
%~\citep{kaber_situation_2006}	D. B. Kaber, C. M. Perry, N. Segall, C. K. McClernon, and L. J. Prinzel, ``Situation awareness implications of adaptive automation for information processing in an air traffic control-related task,'' International Journal of Industrial Ergonomics, vol. 36, no. 5, pp. 447–462, May 2006.
%~\citep{norman_user_1986}	D. A. Norman and S. W. Draper, User Centered System Design; New Perspectives on Human-Computer Interaction. Hillsdale, NJ, USA: L. Erlbaum Associates Inc., 1986.
%~\citep{simoens_internet_2018}	P. Simoens, M. Dragone, and A. Saffiotti, ``The Internet of Robotic Things: A review of concept, added value and applications,'' International Journal of Advanced Robotic Systems, vol. 15, no. 1, p. 1729881418759424, Jan. 2018.
%~\citep{lee_trust_2004}	J. D. Lee and K. A. See, ``Trust in automation: Designing for appropriate reliance,'' Human factors, vol. 46, no. 1, pp. 50–80, 2004.
%~\citep{jian_foundations_2000}	J.-Y. Jian, A. M. Bisantz, and C. G. Drury, ``Foundations for an empirically determined scale of trust in automated systems,'' International Journal of Cognitive Ergonomics, vol. 4, no. 1, pp. 53–71, 2000.
%~\citep{muir_trust_1996}	B. M. Muir and N. Moray, ``Trust in automation. Part II. Experimental studies of trust and human intervention in a process control simulation,'' Ergonomics, vol. 39, no. 3, pp. 429–460, 1996.
%~\citep{SEPPELT201966}	B. D. Seppelt and J. D. Lee, ``Keeping the driver in the loop: Dynamic feedback to support appropriate use of imperfect vehicle control automation,'' International Journal of Human-Computer Studies, vol. 125, pp. 66–80, May 2019.
%~\citep{de_visser_almost_2016}	E. J. de Visser et al., ``Almost human: Anthropomorphism increases trust resilience in cognitive agents,'' Journal of Experimental Psychology: Applied, vol. 22, no. 3, pp. 331–349, 2016.
%~\citep{culley_note_2013}	K. E. Culley and P. Madhavan, ``A note of caution regarding anthropomorphism in HCI agents,'' Computers in Human Behavior, vol. 29, no. 3, pp. 577–579, May 2013.
%~\citep{pak_multi-level_2014}	R. Pak, A. C. McLaughlin, and B. Bass, ``A multi-level analysis of the effects of age and gender stereotypes on trust in anthropomorphic technology by younger and older adults,'' Ergonomics, vol. 57, no. 9, pp. 1277–1289, Sep. 2014.
%~\citep{verberne_trusting_2013}	F. M. F. Verberne, J. Ham, A. Ponnada, and C. J. H. Midden, ``Trusting Digital Chameleons: The Effect of Mimicry by a Virtual Social Agent on User Trust,'' in Persuasive Technology, 2013, pp. 234–245.
%~\citep{fitts_human_1951}	P. M. Fitts, ``Human engineering for an effective air-navigation and traffic-control system,'' Ohio State University Foundation, Columbus, OH, 1951.
%~\citep{tsarouchi_humanrobot_2016}	P. Tsarouchi, S. Makris, and G. Chryssolouris, ``Human–robot interaction review and challenges on task planning and programming,'' International Journal of Computer Integrated Manufacturing, vol. 29, no. 8, pp. 916–931, Aug. 2016.
%~\citep{Singh:2018:CPG:3237383.3237457}	R. Singh, T. Miller, J. Newn, L. Sonenberg, E. Velloso, and F. Vetere, ``Combining Planning with Gaze for Online Human Intention Recognition,'' in Proceedings of the 17th International Conference on Autonomous Agents and MultiAgent Systems, Richland, SC, 2018, pp. 488–496.
%~\citep{ruhland_review_2015}	K. Ruhland et al., ``A Review of Eye Gaze in Virtual Agents, Social Robotics and HCI: Behaviour Generation, User Interaction and Perception,'' Computer Graphics Forum, vol. 34, no. 6, pp. 299–326, 2015.
%~\citep{yanco_analysis_2015}	H. A. Yanco, A. Norton, W. Ober, D. Shane, A. Skinner, and J. Vice, ``Analysis of Human-robot Interaction at the DARPA Robotics Challenge Trials,'' Journal of Field Robotics, vol. 32, no. 3, pp. 420–444, 2015.
%~\citep{endsley2017toward}	M. R. Endsley, ``Toward a Theory of Situation Awareness in Dynamic Systems,'' Hum Factors, vol. 37, no. 1, pp. 32–64, Mar. 1995.
