...
\begin{figure}[!b]
    \begin{center}
        \includegraphics[width=0.8\linewidth]{figures/Introduction/sigrist_review.png}
...
While there are a number of objective techniques that attempt to capture workload, most commonly used techniques are subjective in nature~\citep{hart_development_1988}.
