...
\subsection{Testing Augmented Feedback in Augmented Reality}
...
\subsection{Augmented Feedback in an Electromyography Task}
...
\subsection{Augmented Feedback Benefits Scale with Functional Task Complexity}
...
\subsection{Modeling the Effects of Concurrent Bandwidth Feedback}
