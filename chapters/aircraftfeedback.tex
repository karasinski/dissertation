...
Portions of this chapter were originally published in the conference proceedings for the Human Factors and Ergonomics Society 2019% \citep{karasinski_evaluating_2019}.
...
Augmented feedback, information that relates an individual's performance to a desired performance, has been found to generally enhance motor learning in a wide variety of manual motor control tasks (Salmoni, Schmidt, \& Walter, 1984).
...
% PR	17.8%	21.1%	-
% PRA	20.5%	26.1%	44.2%
% Table 1. Performance improvement of the feedback group over the control group at the end of the experiment for each flight RMSE metric.
...
% de Groot, S., de Winter, J. C., García, J. M. L., Mulder, M., & Wieringa, P. A. (2011). The effect of concurrent bandwidth feedback on learning the lane-keeping task in a driving simulator. Human Factors, 53(1), 50–62.
...
% Heffley, R. K., & Jewell, W. F. (1972). Aircraft handling qualities data.

% Karasinski, J., & Robinson, S. (2019). Evaluating Augmented Reality in a Three-Axis Manual Tracking Task. AIAA Scitech 2019 Forum. Presented at the AIAA Scitech 2019 Forum, San Diego, California. https://doi.org/10.2514/6.2019-1227

% Karasinski, J., Robinson, S., Handley, P., & Duda, K. (2017). Real-Time Performance Feedback in a Manually-Controlled Spacecraft Inspection Task. AIAA Modeling and Simulation Technologies Conference. Presented at the AIAA Modeling and Simulation Technologies Conference, Grapevine, Texas. https://doi.org/10.2514/6.2017-1314

% Roscoe, A. H., & Ellis, G. A. (1990). A Subjective Rating Scale for Assessing Pilot Workload in Flight: A decade of Practical Use (No. RAE-TR-90019). Retrieved from Royal Aerospace Establishment Farnborough (United Kingdom) website: https://apps.dtic.mil/docs/citations/ADA227864
...
% Tannen, R. S., Nelson, W. T., Bolia, R. S., Warm, J. S., & Dember, W. N. (2004). Evaluating adaptive multisensory displays for target localization in a flight task. The International Journal of Aviation Psychology, 14(3), 297–312.

% Zaal, P. M., Pool, D. M., Bruin, J. D., Mulder, M., & Van Paassen, M. M. (2009). Use of pitch and heave motion cues in a pitch control task. Journal of Guidance, Control, and Dynamics, 32(2), 366–377.
